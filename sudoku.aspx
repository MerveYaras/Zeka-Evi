<%@ Page Title="" Language="C#" MasterPageFile="~/Genel.master" AutoEventWireup="true" CodeBehind="sudoku.aspx.cs" Inherits="WebApplication1.sudoku" %>
    ...
    <script>
        ...
        */
        Sudoku.prototype.drawBoard = function () {
            ...
            var sudoku_statistics = $('<div></div>')
                                        .addClass('statistics')
            .html('<b>Rakamlar:</b> <span class="cells_complete">' + this.cellsComplete + '/' + this.cellsNr + '</span> <b>Zaman:</b> <span class="time">' + this.secondsElapsed + '</span>');
            ...
            //draw gameover
            var sudoku_gameover = $('<div class="gameover_container"><div class="gameover">Tebrikler! <button class="restart">Tekrar Oyna</button></div></div>');
        ...
        */
        Sudoku.prototype.addValue = function (value) {
            ...
            console.log('Bitirmek İstiyor musunuz? ', this.cellsComplete, this.cellsNr, (this.cellsComplete === this.cellsNr));
            //game over
...
<asp:Content ID="Content2" ContentPlaceHolderID="cph_Icerik" runat="server">
         ...
         <div style="background-color:white; padding:20px; margin-left:-150px; border-radius :10px;border:10px solid #EE872A; height: 600px; width: 1050px; "><table style="width: 1121px">
     <tr><td style="background-image:url('Resimler/banner.jpg'); background-size:100% 100%;" class="auto-style1">
               <table style="height: 500px; width: 134px">
...
<div id="sudoku_menu">
  <ul>
    <li><a class="restart" href="#">Yeni Oyun</a></li>
    <li></li>
  </ul>
</div>
