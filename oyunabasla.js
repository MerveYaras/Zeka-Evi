$(document).ready(function () {  // Sayfamız hazır olduğu zaman aşağıdaki kodların uygulanacağını söylüyoruz.
    ...
    function animasyon(px) {  // Slider 'ımızın geçiş animasyonu için animasyon adında fonksiyon oluşturuyoruz.
        ...
        }, 800);  // Buradaki değer animasyonun gerçekleşeceği milisaniyeyi belirtiyor.
    }
    ...
    $('#sayfalama a').click(function () {  // #slider 'ın sol alt köşesinde belirlediğimiz 5 adet linke tıklanınca yapılacak işlem için fonksiyon oluşturuyoruz.
        ...
        pozisyon = index * genislik;  // #slider 'ımızı ne kadar sola kaydıracağımızı belirten değişken. Örneğin ikinci linke tıklayınca 1*800 değerini alacaktır.
        ...
        if (index == 3) {  // #sliderımız son sayfaya/slayta geldiğinde sayfalarımız bitmiş olacağı için #slider 'ı en başa götürmemize yarıyan şart cümleciği.
    ...
    //    if (i == 5) {  // #slider 'ımızı son sayfaya geldiğini kontrol eden şart cümleciği
    ...
    //}, 80000);  // Buradaki değer ise zamanlayıcımızın kaç milisaniyede bir çalışması gerektiğini belirtiyor.
