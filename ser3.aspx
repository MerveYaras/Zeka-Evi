<%@ Page Title="" Language="C#" MasterPageFile="~/Genel.master" AutoEventWireup="true" CodeBehind="ser3.aspx.cs" Inherits="WebApplication1.ser3" %>
        ...
        function OpenCard() {
            ...
            if ($("#" + id + " img").is(":hidden")) {
                ...
                if (ImgFound == ImgSource.length) {
                    $("#counter").prepend('<span id="success">Tebrikler 700 puan kazandın.  </span>');
                }
            }
        }
...
<asp:Content ID="Content2" ContentPlaceHolderID="cph_Icerik" runat="server">
    <div style="background-color:white; padding:20px; margin-left:-150px; border-radius :10px;border:10px solid #EE872A; height: 550px; width: 1200px; "><table style="width: 1173px">
     <tr><td style="background-image:url('Resimler/banner.jpg'); background-size:100% 100%;" class="auto-style1">
               <table style="height: 480px; width: 120px">
